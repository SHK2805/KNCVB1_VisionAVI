...
from database.cloud.constants import *
...
class CloudFormationManager:
    def __init__(self, cfm_region_name=region_name,
                       ...
                       cfm_security_group_name=security_group_name,
                       cfm_key_pair_name=os.getenv('KEY_PAIR_NAME')):
        ...
        self.security_group_name = cfm_security_group_name
        ...
        logger.info(f"CloudFormationManager object initialized with stack name: "
                    ...
                    f"key pair name: {self.key_pair_name} ")
                ...
                response = self.cf_client.update_stack(
                    ...
                    Parameters=[
                        ...
                        },
                        {
                            ...
                            'ParameterValue': self.security_group_name
                        }
                    ],
...
def main():
    try:
        ...
        logger.error(f"Error occurred when creating the stack in main: {e}")
        raise CustomException(e, sys)

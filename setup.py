...
setup(
    name="kncvb1 vision avi",  # project name
    version="0.1.0",  # Initial version of a project
    author="Group2",  # Your name author_email="your.email@example.com", # Your email
    description="This is a Computer Vision project.",  # Short description
